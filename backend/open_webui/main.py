...
app.state.config.VIDEO_INDEXER_AZURE_BLOB_SAS = VIDEO_INDEXER_AZURE_BLOB_SAS
app.state.config.VIDEO_INDEXER_AZURE_BLOB_ENDPOINT = VIDEO_INDEXER_AZURE_BLOB_ENDPOINT
app.state.config.VIDEO_INDEXER_AZURE_BLOB_CONTAINER = VIDEO_INDEXER_AZURE_BLOB_CONTAINER
...
app.state.config.SONIOX_UPLOAD_TIMEOUT_SECONDS = SONIOX_UPLOAD_TIMEOUT_SECONDS
app.state.config.SONIOX_REQUEST_TIMEOUT_SECONDS = SONIOX_REQUEST_TIMEOUT_SECONDS
app.state.config.SONIOX_TRANSCRIPT_TIMEOUT_SECONDS = SONIOX_TRANSCRIPT_TIMEOUT_SECONDS
app.state.config.SONIOX_RETRY_ATTEMPTS = SONIOX_RETRY_ATTEMPTS
app.state.config.SONIOX_RETRY_BACKOFF_SECONDS = SONIOX_RETRY_BACKOFF_SECONDS
app.state.config.SONIOX_VIDEO_FFMPEG_BASE_TIMEOUT_SECONDS = (
    SONIOX_VIDEO_FFMPEG_BASE_TIMEOUT_SECONDS
)
app.state.config.SONIOX_VIDEO_FFMPEG_TIMEOUT_PER_MB_SECONDS = (
    SONIOX_VIDEO_FFMPEG_TIMEOUT_PER_MB_SECONDS
)
app.state.config.SONIOX_VIDEO_FFMPEG_MAX_TIMEOUT_SECONDS = (
    SONIOX_VIDEO_FFMPEG_MAX_TIMEOUT_SECONDS
)
app.state.config.RESUMABLE_UPLOAD_CHUNK_SIZE_BYTES = RESUMABLE_UPLOAD_CHUNK_SIZE_BYTES
app.state.config.RESUMABLE_UPLOAD_SESSION_TTL_SECONDS = (
    RESUMABLE_UPLOAD_SESSION_TTL_SECONDS
)
